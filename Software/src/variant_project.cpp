/*
	Copied variant implementation so the custom variant is compiled from src/.
	This avoids including a .cpp from outside src at compile-time while keeping
	the project's variant implementation available to the linker.
*/
